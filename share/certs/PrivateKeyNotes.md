...
unlocked to sign the Peso-Qt.app bundle.
...
allowing somebody to distribute a Peso-Qt.app or Peso-qt-setup.exe with a valid
...
that the Peso-qt.exe file inside the installer had not been tampered with.
