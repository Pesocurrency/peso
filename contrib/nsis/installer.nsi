# This installs Peso, creates a start menu shortcut, builds an uninstaller, and
...
!define HELPURL "http://Peso.org" # "Support Information" link
!define UPDATEURL "http://Peso.org" # "Product Updates" link
!define ABOUTURL "http://Peso.org" # "Publisher" link
...
section "install"
	...
	createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\Peso-qt.exe" "" "$INSTDIR\Peso.ico"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$\"$INSTDIR\Peso.ico$\""
...
section "uninstall"
	...
	delete $INSTDIR\Pesod.exe
	delete $INSTDIR\Peso-qt.exe
	delete $INSTDIR\Peso.ico
